...
- Git/GitHubの認証設定
  ...
  - Gitの設定
    ...
    git config --global alias.default-branch '!git symbolic-ref refs/remotes/origin/HEAD | awk -F'\''[/]'\'' '\''{print $NF}'\'''
...
- 必要なアプリケーションのインストール
  ...
  - Zoomのインストール
    ...
    - ビデオ
      - 「ミーティングの参加時にビデオを停止」チェックをつける✅
    - オーディオ
      - 「参加時にコンピュータオーディオに自動接続する」チェックをつける✅
